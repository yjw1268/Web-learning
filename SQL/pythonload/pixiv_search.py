...
class Pixiv(object):
    ...
    def __init__(self):
        ...
        self.search_url_long='https://www.pixiv.net/search.php?s_mode=s_tag&order=date_d&word='
    ...
    def search(self):
        self.searchcode = sys.argv[1]  # 搜索关键词
    ...
    def sbeautifulsoup(self):
        # print(self.searchcode)
        # payload = {'s_mode': 's_tag', 'word': self.searchcode,'order':'date_d','p':self.page}
        s = se.get(self.search_url_long + self.searchcode+'&p='+str(self.page))
        # print(s.url)
        self.page += 1
